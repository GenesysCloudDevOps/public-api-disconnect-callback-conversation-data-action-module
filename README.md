A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Disconnect Callback Conversation
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-disconnect-callback-conversation-data-action-module.git?ref=v1.0.0"
    action_name        = "Disconnect Callback Conversation"
